...
extension PreviewProvider {
    // any time we call PreviewProvider we can then call dev and give us the instance of this DeveloperPreview that we want
...
class DeveloperPreview {
    ...
    let stat2 = Statistic(title: "Total Volume", value: "$1.23Tn")
