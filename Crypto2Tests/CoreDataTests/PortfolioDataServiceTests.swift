...
//        var updatedEntities: [PortfolioEntityProtocol?]
//
//        //Create the stream
//        let stream = try service.getPortfolio()
//
//        let newEntities: [PortfolioEntityProtocol?] = [MockPortfolioEntity(amount: 10, coinID: sampleCoin.id)]
//        //Make a change
//        service.updatePortfolio(coin: sampleCoin, amount: 20)
...
//        XCTAssertEqual(newEntities, updatedEntities)
//    }
